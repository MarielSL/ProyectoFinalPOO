...
public class ReporteEmpresas extends JDialog {
	...
	public ReporteEmpresas() {
		...
		panelStats.add(crearBloque("Total de empresas", String.valueOf(total), new Color(0, 120, 0)));
		panelStats.add(crearBloque("Empresas activas", String.valueOf(activas), new Color(204, 102, 0)));
